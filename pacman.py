...
pacman_pos = [random.randint(0, num_column-2), random.randint(0, num_row)]
comida_pos = [random.randint(0, num_column-2), random.randint(0, num_row)]
...
while keyboard.is_pressed('Esc') == False:
    ...
    if pacman_pos == comida_pos: comida_pos = [random.randint(0, num_column-2), random.randint(0, num_row)]
    matriz[comida_pos[0]][comida_pos[1]] = 'X'
